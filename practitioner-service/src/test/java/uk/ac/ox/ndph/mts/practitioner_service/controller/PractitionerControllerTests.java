...
class PractitionerControllerTests {
    ...
    void TestPostPractitioner_WhenNoInput_Returns400() throws Exception {
        ...
        // Act + Assert
        this.mockMvc.perform(post("/practitvgvvioner").contentType(MediaType.APPLICATION_JSON)).andDo(print())
    ...
    void TestPostPractitioner_WhenValidInput_Returns201AndId() throws Exception {
        ...
        // Act + Assert
        this.mockMvc.perform(post("/practitioner").contentType(MediaType.APPLICATION_JSON).content(jsonString))
